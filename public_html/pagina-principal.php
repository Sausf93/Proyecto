...
<nav class="navbar navbar-light" style="background-color: #519CF1;">
    <a class="navbar-brand" href=""><img src="../img/icon.png" alt="Icono de la pagina"> <img src="../img/jsg1.png" alt="Titulo de la app"></a>
    <a href="puntuaciones.php"><button class="btn btn-outline-dark" type="button">Puntuaciones</button></a>
    <a href="index.php"><button class="btn btn-outline-dark" type="button">Log out</button></a>
...
<br>
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
            <div class="card-body">
                <img src="../img/cartas-pokemon.png" style="width:100%;height:350px;" alt="Imagen del pokemon">
                <h5 class="card-title" style="text-align: center;">Cartas pokemon</h5>
                <p style="text-align: center;"><a href="../Pokemon-Cards-gh-pages/index.html"  class="btn btn-primary">Cartas pokemon</a></p>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
